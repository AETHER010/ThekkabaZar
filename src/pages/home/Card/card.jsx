        ...
        <div className="flex flex-col w-3/4">
          ...
          {isgrid ? (
            <Card className="p-2" sx={{ maxWidth: 348 }}>
              <CardMedia sx={{ height: 140 }} image={GridImage} title="bids" />
              <CardContent>
                <div className="flex flex-row ">
                  <span>
                    <CalendarMonthIcon />
            ...
            >
              <CardContent className="w-4/5">
                ...
                <p className="text-[#565252] font-popins text-md mt-3 overflow-hidden line-clamp-2">
                  ...
                  Capital (then NIBL Capital) aim where creativity and
                  innovation shine! NIMBA Ace Capital Limited s a wholly owned
                  subsidiary of Nepal Investment Mega Bank Limited. Established
                  in 2011, NIMB Ace Capital (then NIBL Capital) aim where
